 ...
 */
final class Version20181121181820 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comments (id INT AUTO_INCREMENT NOT NULL, message_id INT NOT NULL, content LONGTEXT NOT NULL COLLATE latin1_swedish_ci, token VARCHAR(10) NOT NULL COLLATE latin1_swedish_ci, date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messages (id INT UNSIGNED AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL COLLATE latin1_swedish_ci, category VARCHAR(100) NOT NULL COLLATE latin1_swedish_ci, date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, upvotes INT DEFAULT 0 NOT NULL, downvotes INT DEFAULT 0 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(80) NOT NULL COLLATE latin1_swedish_ci, password VARCHAR(80) NOT NULL COLLATE latin1_swedish_ci, admin TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
